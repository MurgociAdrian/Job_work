...
class TestClass(unittest.TestCase):
   ...
   def test_joke_type(self):
      r = ReadFromAPI()
      r.store_10_random_jokes_by_type("general")  # tipuri: knock-knock, general, programming
      for i in range(len(r.json_obj)):
         self.assertEqual(r.json_obj[i]["type"], "general", '''The joke nr {} is not of type {}'''.format(i, "general"))
