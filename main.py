...
class CloudCtx():
    ...
    def __repr__(self):
        ...
        return """CloudCtx -> name: {}  tenant_name: {}  description: {}  name_alias: {}  ctx_profile_name: {} 
                  displayed_health: {} \n""".format(self.name, self.tenant_name, self.description, self.name_alias,
                                             self.ctx_profile_name, self.reference_to_health_inst.displayed_health)
...
#CloudCtx.display_specific_info(5)
...
#print(repr(HealthInst.LIST_HEALTH_OBJ[1]))